...
function NewUniversityForm() {
    ...
    async function submitUniversity(e) {
        ...
        .catch(() => {
            ...
            setVariant('danger');
            setMessage('University failed to submit!');
            setShowAlert(true);
        })
    }

    return (
        <Form className="new-thesis-form" onSubmit={(e) => { submitUniversity(e) }}>
            {
                showAlert ?
            ...
            <Form.Group controlId="formCountry">
                ...
                <br></br>
                <select id="country" name="country" defaultValue="Greece" onChange={(e) => setCOuntry(e.target.value)}>
