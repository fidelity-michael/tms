...
export default function SecretariatTopbar(props) {
            ...
            <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle" href="#/" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        {/* <span className="mr-2 d-lg-inline text-gray-600 medium profile-name">Secretariat</span> */}
                        <span className="mr-2 d-lg-inline text-gray-600 medium profile-name">{props.email.length > 0 ? props.email : "Secretariat"}</span>
                    </a>
