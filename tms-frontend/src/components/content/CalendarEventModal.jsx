    ...
    return (
        <Modal show={show} onHide={(e) => onShow(false) } animation={false}>
            ...
            <Modal.Body>
                ...
                <p className="eventFieldInfo" id="eventField">Please fill in your event field</p>

                <div>
                    <label>Date:</label>
                    <Datetime value={date} onChange={(data) => {setDate(data._d)}} id="dateInput"/>
                </div>
                <p className="eventFieldInfo" id="dateField">Please fill in your date field</p>

                <button className="btn btn-success addEvent" onClick={() => {saveNewEvent()}}>Add Event</button>
                
                <div className="resultDiv">
                    <p className="eventSaved" id="success">Event saved successfully!</p>
                    <p className="eventFieldInfo" id="failed">Failed to save event.</p>
                </div>
