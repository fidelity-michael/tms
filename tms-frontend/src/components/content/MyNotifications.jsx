...
export default function MyNotifications({ userId, notifications, setNotifications, badge,setBadge}) {
                ...
                <div key={_id} className="notification">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <span style={{ color: "#528bba", fontWeight: "500" }}><b>{title}</b></span>
                            <p style={{ color: "#609ed1", fontWeight: "500", maxWidth: "50vw", overflowWrap: "break-word"}}>{message}</p>
                        </div>
                    </div>
                </div>
            )
    ...
    function emptyData(e) {
        return (
            <h5 className='empty-data'
                ...
                }}>There are no notifications yet</h5>
        );
    }
    ...
    return (
        <div className="notifications-wrapper">
            ...
            <div className="notifications-content">
                {
                    loadingNotifications ? loadingData() : (notifications.length ? renderNotifications() : emptyData())
                }
                <a className="dropdown-item text-center small text-gray-500" onClick={() => toggleShowMore()}>
